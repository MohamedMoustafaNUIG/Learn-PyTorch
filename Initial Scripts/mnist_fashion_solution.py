...
def train():
	...
	model = Classifier().cuda() if torch.cuda.is_available() else Classifier()
	...
	for e in range(epochs):
		...
		for images, labels in train:
			...
			'''
			print("Training loss is : "+str(running_loss/len(data))+" at epoch: "+str(e+1)+" of "+str(epochs))
			print("Training accuracy is : "+str(running_acc/batch_num * 100)+" at epoch: "+str(e+1)+" of "+str(epochs))
			'''
			test_loss=0
			accuracy=0
			with torch.no_grad():
